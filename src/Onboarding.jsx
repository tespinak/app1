...
function ChoiceCard({ label, selected, onClick, theme, icon: Icon }) {
  return (
    <button
      ...
      style={{
        width: '100%',
        border: `1px solid ${selected ? 'rgba(59,130,246,0.42)' : theme.border}`,
        borderRadius: 24,
        padding: '18px 16px',
        textAlign: 'left',
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
        <div style={{ width: 42, height: 42, borderRadius: 16, display: 'grid', placeItems: 'center', background: selected ? '#1d4ed8' : theme.mode === 'dark' ? '#0f172a' : '#eff6ff', transition: theme.transition }}>
  ...
  return (
    ...
    >
      <div style={{ marginBottom: 18 }}>
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '7px 11px', borderRadius: 999, background: theme.mode === 'dark' ? 'rgba(37,99,235,0.16)' : '#eff6ff', color: '#2563eb', fontSize: 11, fontWeight: 900, letterSpacing: 0.4, marginBottom: 12, transition: theme.transition }}>
          {stepLabel}
        </div>
        <div style={{ width: 44, height: 44, borderRadius: 16, display: 'grid', placeItems: 'center', background: theme.mode === 'dark' ? '#0f172a' : '#eff6ff', marginBottom: 12, transition: theme.transition }}>
